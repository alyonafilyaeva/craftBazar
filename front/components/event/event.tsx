    ...
    return (
        <View style={styles.event}>
            ...
            <View style={styles.date}>
                <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 14, fontWeight: '700', color: colors.accentColor }}>08</Text>
                <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 14, fontWeight: '700', color: colors.accentColor }}>12</Text>
            </View>
