        ...
        <View style={styles.block}>
            <View style={{display: 'flex', flexDirection: 'row', marginBottom: paddings.elementPadding}}>
                ...
                <View style={{marginLeft: paddings.elementPadding}}>
                    ...
                    <Text style={{fontFamily: 'Montserrat-Medium', fontSize: fonts.descriptionFont, color: colors.greyColor}}>{props.invetation?.date_start.slice(0, 10)}</Text>
                    <Text style={{fontFamily: 'Montserrat-Medium', fontSize: fonts.descriptionFont, color: colors.greyColor}}>{props.invetation?.address}</Text>
                </View>
            </View>
