...
export default function Navbar() {
    ...
    return (
        <Tab.Navigator screenOptions={{ tabBarShowLabel: false, headerShown: false }}>
            ...
            <Tab.Screen name='Account' component={AccountNavigation} options={{ tabBarIcon: ({ focused }) => (<FontAwesome5 name="user-circle" size={30} color={focused ? colors.accentColor : colors.greyColor} />) }} />
        </Tab.Navigator>
    )
}